...
CREATE TABLE `article_comments`  (
  ...
  UNIQUE INDEX `UK_b3ictjw4p8ml22bici0ee8uem`(`cid` ASC) USING BTREE,
...
-- Records of clients
-- ----------------------------
INSERT INTO `clients` VALUES (1, 'Hi, I\'m user1.', 'http://101.132.129.104:5174/image/user1.jpg', 0.00, 'Emily', 'Smith', 'Shanghai, China', 'user1', 2);
INSERT INTO `clients` VALUES (2, 'I\'m user2, nice to meet you.', 'http://101.132.129.104:5174/image/user2.jpg', 0.00, 'Liam', 'Johnson', 'Tokyo, Japan', 'user2', 3);
INSERT INTO `clients` VALUES (3, 'User3 here, exploring the digital realm.', 'http://101.132.129.104:5174/image/user3.jpg', 0.00, 'Sophia', 'Williams', 'New York City, USA', 'user3', 4);
INSERT INTO `clients` VALUES (4, 'User4, passionate about tech and creativity.', 'http://101.132.129.104:5174/image/user4.jpg', 0.00, 'Noah', 'Brown', 'London, United Kingdom', 'user4', 5);
INSERT INTO `clients` VALUES (5, 'Hey, I\'m user5, always up for a chat.', 'http://101.132.129.104:5174/image/user5.jpg', 0.00, 'Olivia', 'Jones', 'Paris, France', 'user5', 6);
INSERT INTO `clients` VALUES (6, 'User6, curious mind and a penchant for learning.', 'http://101.132.129.104:5174/image/user6.jpg', 0.00, 'Ethan', 'Garcia', 'Berlin, Germany', 'user6', 7);
INSERT INTO `clients` VALUES (7, 'I\'m user7, lover of all things innovative.', 'http://101.132.129.104:5174/image/user7.jpg', 0.00, 'Ava', 'Miller', 'Sydney, Australia', 'user7', 8);
INSERT INTO `clients` VALUES (8, 'User8, embracing the digital age with gusto.', 'http://101.132.129.104:5174/image/user8.jpg', 0.00, 'Mason', 'Davis', 'Rio de Janeiro, Brazil', 'user8', 9);
INSERT INTO `clients` VALUES (9, 'Hey there, I\'m user9, ready for new adventures.', 'http://101.132.129.104:5174/image/user9.jpg', 0.00, 'Isabella', 'Rodriguez', 'Moscow, Russia', 'user9', 10);
INSERT INTO `clients` VALUES (10, 'User10, tech enthusiast and problem solver.', 'http://101.132.129.104:5174/image/user10.jpg', 0.00, 'Lucas', 'Martinez', 'Dubai, United Arab Emirates', 'user10', 11);
INSERT INTO `clients` VALUES (11, 'I\'m user11, seeking connections and knowledge.', 'http://101.132.129.104:5174/image/user11.jpg', 0.00, 'Mia', 'Hernandez', 'Mumbai, India', 'user11', 12);
INSERT INTO `clients` VALUES (12, 'User12, on a journey of discovery and growth.', 'http://101.132.129.104:5174/image/user12.jpg', 0.00, 'Alexander', 'Lopez', 'Toronto, Canada', 'user12', 13);
INSERT INTO `clients` VALUES (13, 'Hi, I\'m user13, excited to engage and learn.', 'http://101.132.129.104:5174/image/user13.jpg', 0.00, 'Charlotte', 'Gonzalez', 'Seoul, South Korea', 'user13', 14);
INSERT INTO `clients` VALUES (14, 'User14, fueled by curiosity and ambition.', 'http://101.132.129.104:5174/image/user14.jpg', 0.00, 'Benjamin', 'Wilson', 'Mexico City, Mexico', 'user14', 15);
INSERT INTO `clients` VALUES (15, 'User15 here, ready to dive into the digital world.', 'http://101.132.129.104:5174/image/user15.jpg', 0.00, 'Amelia', 'Anderson', 'Cape Town, South Africa', 'user15', 16);
INSERT INTO `clients` VALUES (16, NULL, NULL, 0.00, NULL, NULL, NULL, 'zh', 49);
...
CREATE TABLE `comment_likes`  (
  ...
  `uid` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKgn4lflqs5ytbhus0j7tqiy0ch`(`cid` ASC) USING BTREE,
  INDEX `FKb4nw8sxcs5nfa5j7677curwxd`(`uid` ASC) USING BTREE,
...
CREATE TABLE `consultations`  (
  ...
  `eid` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK7vqdtht58yhhmpmk59cg9y2ld`(`cid` ASC) USING BTREE,
  INDEX `FKdgdget4lckv621a4yrfojtqfn`(`eid` ASC) USING BTREE,
...
-- ----------------------------
INSERT INTO `consultations` VALUES (1, '2024-05-14 10:58:54.782552', 16, 1);
INSERT INTO `consultations` VALUES (2, '2024-05-14 10:54:40.000000', 16, 2);
...
CREATE TABLE `expert_comments`  (
  ...
  `uid` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `UK_9qdscvtq29g7u257x2y8p5u10`(`cid` ASC) USING BTREE,
...
CREATE TABLE `expert_speciality`  (
  `eid` int NOT NULL,
  `sid` int NOT NULL,
  INDEX `FKi7243v83q513ue46ikgwpbuyf`(`sid` ASC) USING BTREE,
  INDEX `FKmp13rlsk1nt2dki0tys4pe5ki`(`eid` ASC) USING BTREE,
...
-- Records of experts
-- ----------------------------
INSERT INTO `experts` VALUES (1, 'Hello, I\'m Emma Johnson, a software engineer passionate about crafting elegant solutions to complex problems.', 'http://101.132.129.104:5174/image/1.jpg', '2008.9-2012.6, Stanford University, Bachelor\'s Degree in Computer Sciencen2012.9-2014.3, Stanford University, Master\'s Degree in Software Engineering', 'Emma', 'Johnson', 'Emma Johnson', 40.00, 4.5, 'San Francisco, USA', 37);
INSERT INTO `experts` VALUES (2, 'I\'m Alex White, a medical doctor specializing in cardiology. I\'m dedicated to providing top-notch healthcare services to my patients.', 'http://101.132.129.104:5174/image/2.jpg', '2005.9-2011.6, Johns Hopkins University, Doctor of Medicinen2011.9-2015.3, Johns Hopkins University, Cardiology Residency Program', 'Alex', 'White', 'Alex White', 45.00, 4.0, 'New York City, USA', 38);
INSERT INTO `experts` VALUES (3, 'Greetings, I\'m Sophia Clark, an expert in philosophy with a deep understanding of ethical dilemmas and moral reasoning.', 'http://101.132.129.104:5174/image/3.jpg', '2007.9-2011.6, Oxford University, Bachelor\'s Degree in Philosophyn2011.9-2013.3, Oxford University, Master\'s Degree in Ethics and Morality', 'Sophia', 'Clark', 'Sophia Clark', 35.00, 4.5, 'London, UK', 39);
INSERT INTO `experts` VALUES (4, 'Hi, I\'m David Smith, a cybersecurity specialist committed to safeguarding digital assets and ensuring data protection.', 'http://101.132.129.104:5174/image/4.jpg', '2009.9-2013.6, MIT, Bachelor\'s Degree in Computer Engineeringn2013.9-2015.3, MIT, Master\'s Degree in Cybersecurity', 'David', 'Smith', 'David Smith', 50.00, 4.0, 'Boston, USA', 40);
INSERT INTO `experts` VALUES (5, 'Salutations, I\'m Lily Wang, a nutritionist dedicated to promoting healthy lifestyles and balanced dietary habits.', 'http://101.132.129.104:5174/image/5.jpg', '2010.9-2014.6, Cornell University, Bachelor\'s Degree in Nutritional Sciencesn2014.9-2016.3, Cornell University, Master\'s Degree in Dietetics', 'Lily', 'Wang', 'Lily Wang', 35.00, 4.5, 'Los Angeles, USA', 41);
INSERT INTO `experts` VALUES (6, 'Hey there, I\'m Nathan Lee, an environmental scientist dedicated to researching sustainable solutions for a greener future.', 'http://101.132.129.104:5174/image/6.jpg', '2006.9-2010.6, UCLA, Bachelor\'s Degree in Environmental Sciencen2010.9-2012.3, UCLA, Master\'s Degree in Sustainable Development', 'Nathan', 'Lee', 'Nathan Lee', 40.00, 4.0, 'San Diego, USA', 42);
INSERT INTO `experts` VALUES (7, 'Hello, I\'m Olivia Brown, a design expert passionate about creating innovative and user-centric visual experiences.', 'http://101.132.129.104:5174/image/7.jpg', '2007.9-2011.6, Parsons School of Design, Bachelor\'s Degree in Graphic Designn2011.9-2013.3, Parsons School of Design, Master\'s Degree in Product Design', 'Olivia', 'Brown', 'Olivia Brown', 45.00, 4.5, 'New York City, USA', 43);
INSERT INTO `experts` VALUES (8, 'Greetings, I\'m Ethan Miller, a finance expert with a keen eye for investment strategies and financial planning.', 'http://101.132.129.104:5174/image/8.jpg', '2009.9-2013.6, Wharton School at UPenn, Bachelor\'s Degree in Financen2013.9-2015.3, Wharton School at UPenn, Master\'s Degree in Financial Management', 'Ethan', 'Miller', 'Ethan Miller', 40.00, 4.0, 'Philadelphia, USA', 44);
INSERT INTO `experts` VALUES (9, 'Hi there, I\'m Grace Taylor, an experienced psychologist dedicated to promoting mental wellness and emotional resilience.', 'http://101.132.129.104:5174/image/9.jpg', '2008.9-2012.6, Stanford University, Bachelor\'s Degree in Psychologyn2012.9-2014.3, Stanford University, Master\'s Degree in Clinical Psychology', 'Grace', 'Taylor', 'Grace Taylor', 35.00, 4.5, 'San Francisco, USA', 45);
INSERT INTO `experts` VALUES (10, 'Salutations, I\'m Jack Robinson, a marketing specialist dedicated to crafting strategic campaigns and enhancing brand presence.', 'http://101.132.129.104:5174/image/10.jpg', '2009.9-2013.6, NYU Stern School of Business, Bachelor\'s Degree in Marketingn2013.9-2015.3, NYU Stern School of Business, Master\'s Degree in Brand Management', 'Jack', 'Robinson', 'Jack Robinson', 50.00, 4.0, 'New York City, USA', 46);
INSERT INTO `experts` VALUES (11, 'Hey there, I\'m Mia Chang, a legal expert specializing in corporate law and contractual negotiations.', 'http://101.132.129.104:5174/image/11.jpg', '2006.9-2010.6, Harvard Law School, Juris Doctor (JD)n2010.9-2012.3, Harvard Law School, Master of Laws (LLM)', 'Mia', 'Chang', 'Mia Chang', 35.00, 4.5, 'Boston, USA', 47);
INSERT INTO `experts` VALUES (12, 'Greetings, I\'m Lucas Garcia, a business consultant passionate about driving organizational growth and strategic planning.', 'http://101.132.129.104:5174/image/12.jpg', '2007.9-2011.6, INSEAD, Bachelor\'s Degree in Business Administrationn2011.9-2013.3, INSEAD, Master\'s Degree in Strategic Management', 'Lucas', 'Garcia', 'Lucas Garcia', 40.00, 4.0, 'Paris, France', 48);
...
-- Records of messages
-- ----------------------------
INSERT INTO `messages` VALUES (1, '123', b'0', '2024-05-14 10:58:54.735772', 37, 49);
...
CREATE TABLE `tweet_comments`  (
  ...
  `uid` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `UK_ee77tv2sl0ptfcm2t08jf6pig`(`cid` ASC) USING BTREE,
...
CREATE TABLE `tweet_likes`  (
  ...
  `uid` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKj4mcavi7xwy5h89a7ax2ro64`(`tid` ASC) USING BTREE,
  INDEX `FKqghk7sb5a7wct4n3ci619iva`(`uid` ASC) USING BTREE,
...
CREATE TABLE `tweets`  (
  ...
  `uid` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK61fnyj065fm3yq0g3h3ak1big`(`uid` ASC) USING BTREE,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (2, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (3, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (4, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (5, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (6, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (7, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (8, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (9, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (10, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (11, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (12, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (13, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (14, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (15, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (16, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (36, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (37, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (38, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (39, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (40, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (41, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (42, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (43, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (44, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (45, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (46, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (47, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (48, NULL, b'1', NULL, NULL);
INSERT INTO `users` VALUES (49, '2670617505@qq.com', b'1', '$2a$10$pRq3WcTc7px2jzhU8Rj0NetFEaArd1IdGJRYluIiP2BZ2bkm3/Woq', 'user');
