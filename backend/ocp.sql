...
-- Records of articles
-- ----------------------------
INSERT INTO `articles` VALUES (1, '### 又 </br> \\n yiyi', '/1.jpg', 'Modern Advances in Economics', 1, NULL);
...
CREATE TABLE `expert_applications`  (
  ...
  `about_me` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- Records of experts
-- ----------------------------
INSERT INTO `experts` VALUES (1, 1, 'Professor Zhang San, Ph.D. in Economics, with 20 years of experience in the finance industry.', 'Zhang San', 100.00, 5.0, '/1.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- Records of messages
-- ----------------------------
INSERT INTO `messages` VALUES (171, '55\n', b'1', '2024-05-06 22:15:35.000000', 1, 2, b'0');
INSERT INTO `messages` VALUES (172, '12', b'0', '2024-05-06 22:16:50.000000', 2, 1, b'0');
INSERT INTO `messages` VALUES (173, '？', b'0', '2024-05-06 22:23:30.000000', 1, 1, b'0');
INSERT INTO `messages` VALUES (174, '？\n', b'0', '2024-05-06 22:23:34.000000', 3, 1, b'0');
INSERT INTO `messages` VALUES (175, '哈哈', b'0', '2024-05-06 22:27:48.800508', 1, 1, b'0');
INSERT INTO `messages` VALUES (176, '123', b'0', '2024-05-06 22:30:37.870984', 3, 1, b'0');
INSERT INTO `messages` VALUES (177, '？', b'0', '2024-05-06 22:31:05.451667', 2, 2, b'0');
INSERT INTO `messages` VALUES (178, '\n👩🏼‍💻', b'0', '2024-05-06 22:31:07.972807', 2, 2, b'0');
INSERT INTO `messages` VALUES (179, '🥂', b'0', '2024-05-06 22:31:32.731269', 1, 1, b'0');
INSERT INTO `messages` VALUES (180, '\n👩🏼‍💻👩🏼‍💻👩🏼‍💻👩🏼‍💻', b'0', '2024-05-06 22:31:42.264172', 3, 2, b'0');
INSERT INTO `messages` VALUES (181, '😭😭😭😭', b'0', '2024-05-06 22:31:44.630950', 3, 2, b'0');
INSERT INTO `messages` VALUES (182, '？', b'0', '2024-05-06 22:32:00.414086', 3, 1, b'0');
INSERT INTO `messages` VALUES (183, '？', b'0', '2024-05-06 22:34:07.432987', 3, 1, b'0');
INSERT INTO `messages` VALUES (184, '？\n', b'0', '2024-05-06 22:35:05.609644', 3, 1, b'0');
INSERT INTO `messages` VALUES (185, '\n😭😭😭', b'0', '2024-05-06 22:35:16.210137', 1, 1, b'0');
INSERT INTO `messages` VALUES (186, '😭😭', b'0', '2024-05-06 22:35:24.885723', 3, 2, b'0');
INSERT INTO `messages` VALUES (187, '😭🥂🥂🥂🥂', b'0', '2024-05-06 22:35:29.438429', 2, 2, b'0');
INSERT INTO `messages` VALUES (188, '😭', b'0', '2024-05-06 22:37:26.685177', 3, 1, b'0');
INSERT INTO `messages` VALUES (189, 'sad', b'0', '2024-05-06 22:37:29.968868', 3, 1, b'0');
INSERT INTO `messages` VALUES (190, '哈哈', b'0', '2024-05-06 22:37:49.901494', 3, 3, b'0');
INSERT INTO `messages` VALUES (191, '\n自嗨', b'0', '2024-05-06 22:37:51.221765', 3, 3, b'0');
INSERT INTO `messages` VALUES (192, '\n💖💖💖', b'0', '2024-05-06 22:37:55.757856', 3, 3, b'0');
INSERT INTO `messages` VALUES (193, '您好', b'0', '2024-05-06 22:38:04.886679', 2, 3, b'0');
INSERT INTO `messages` VALUES (194, '👩🏼‍💻', b'0', '2024-05-07 08:40:40.892591', 1, 1, b'0');
INSERT INTO `messages` VALUES (195, 'crazy', b'0', '2024-05-07 11:03:33.138111', 1, 1, b'0');
INSERT INTO `messages` VALUES (196, '👩🏼‍💻👩🏼‍💻', b'0', '2024-05-07 11:03:41.656295', 1, 1, b'0');
INSERT INTO `messages` VALUES (197, '👩🏼‍💻', b'0', '2024-05-07 11:04:10.520830', 1, 1, b'0');
...
CREATE TABLE `replies`  (
  ...
  CONSTRAINT `FKhmbbhlps50ob17p65ngttsndu` FOREIGN KEY (`cid`) REFERENCES `article_comments` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `users`  (
  ...
  `level` int NOT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `role` enum('admin','expert','user') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, NULL, '/1.jpg', NULL, b'1', 1, '123', 'expert', NULL, 'admin', NULL);
INSERT INTO `users` VALUES (2, NULL, '/2.jpg', NULL, b'1', 1, '123', 'user', NULL, 'zh', NULL);
INSERT INTO `users` VALUES (3, NULL, '/3.jpg', NULL, b'1', 1, '123', 'user', NULL, 'nwdnysl', NULL);
INSERT INTO `users` VALUES (4, '1', '1', '1', b'1', 1, '123', 'admin', '1', '123', 1);
