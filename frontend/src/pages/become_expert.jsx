      ...
      {!submitted && (
        <div className="items-start px-14 pt-9 rounded-xl max-md:px-5">
          ...
          >
            ...
            <button className=" cursor-pointer justify-center items-center self-stretch px-5 py-2.5 mt-10 text-base font-semibold leading-6 text-white bg-blue-400 rounded-lg border border-gray-400 border-solid shadow-sm max-md:max-w-full w-3/4 mx-auto">
