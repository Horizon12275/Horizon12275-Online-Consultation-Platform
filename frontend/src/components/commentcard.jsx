    ...
    return (
        <div className="selected-comment-card">
            ...
            <div className="selected-comment-card__content">
                ...
                <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/65b2e6e7af9c42d7ef731eaacc25aa35466c97ec9c70b6c7c6a3963f9bee0ec4?apiKey=b565e599026f4ea2ba591e53566a67d8&" alt="Author profile picture" className="selected-comment-card__author-image" />
...
function Commentcard() {
    const selectedComments = [
        {
            comment: "Had avoided learning Auto Layout until I'd stumbled upon Pablo's YT videos and example files. As a full time developer and part time designer, this helped me understand the basic and actual implementation with ease. Thanks! 💪",
        ...
        <>
            <main className="main-container">
                {selectedComments.map((comment, index) => (
                    <SelectedCommentCard key={index} comment={comment.comment} author={comment.author} />
                ))}
            </main>
