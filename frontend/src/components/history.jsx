...
const VoiceChatItem = ({ topic, date, time }) => (
  <div className="voice-chat-item ">
    <img
      src="https://cdn.builder.io/api/v1/image/assets/TEMP/c5c75be9173a9a3d1648c07e1da814a3cd82ca36e33765804d5ced14a350ff44?apiKey=b565e599026f4ea2ba591e53566a67d8&"
      alt="Voice chat icon"
    ...
    <img
      src="https://cdn.builder.io/api/v1/image/assets/TEMP/d162d9fa1ec3e4ae4981cd504aa6b0c231a41c0ac79e74f2906fe2770110d5b4?apiKey=b565e599026f4ea2ba591e53566a67d8&"
      alt="Arrow icon"
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .voice-chat-topic {
          font: 600 14px Public Sans, -apple-system, Roboto, Helvetica,
            sans-serif;
        }

        .voice-chat-time-label {
          font: 400 12px Public Sans, -apple-system, Roboto, Helvetica,
            sans-serif;
        }
